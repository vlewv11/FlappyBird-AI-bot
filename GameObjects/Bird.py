...
class Bird:
    ...
    # Set the desired bird size
    BIRD_WIDTH = 34  # Desired width of the bird
    BIRD_HEIGHT = 24  # Desired height of the bird
    ...
    def load_frames(self):
        self.frames = [pygame.transform.scale(
            pygame.image.load(os.path.join(config.TEXTURES_DIR, "bird_" + self.color.lower() + str(x) + ".png")).convert_alpha(),
